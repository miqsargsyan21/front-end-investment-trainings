function addingMemberInTable () {
    ...
    if (nameMember.value && surnameMember.value && ageMember.value && gradeMember.value) {
        ...
        if (ageMember.value >= 6 && ageMember.value <= 18 && gradeMember.value >= 1 && gradeMember.value <= 12 && nameMember.value[0] != " " && surnameMember.value[0] != " ") {
            let itemForArray = {
                name: nameMember.value,
                surname: surnameMember.value,
                age: +(ageMember.value),
                grade: +(gradeMember.value),
            };

            learnersData.push(itemForArray);
            ...
            editMemberInTable.setAttribute('id', ('id2' + String(idMember)));
